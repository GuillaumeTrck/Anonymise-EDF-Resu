...
# anonymeNames=ChangeNameToAnonyme("PERSONX0-20220928.resu","PX428090.EDF",ID)
# originalsNames=ChangeAnonymeToName(anonymeNames[0],anonymeNames[1], matriceEDF,matriceresu)       
...
for resu in resuList:
    ...
    #2. trouver l'edf 
    term='.EDF'
    print(RawFileNameStrip + term)
    EDFName=glob.glob(RawFileName + term)
    print(EDFName)
...
#findEDFID=LinkingResuIDAndEDFID()
